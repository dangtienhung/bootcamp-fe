...
const ProductDetail = () => {
	...
	const handleAddToCart = () => {
		if (selectedVariant) {
			console.log("🚀 ~ handleAddToCart ~ selectedVariant:", selectedVariant);
			console.log("🚀 ~ handleAddToCart ~ selectedQuantity:", selectedQuantity);

			// Here you would typically dispatch an action or call a function to add the item to the cart
		} else {
			console.log("Please select a size and color before adding to cart");
		}
	};
